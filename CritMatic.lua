...
f:SetScript("OnEvent", function(self, event)
    ...
    if sourceGUID == UnitGUID("player") and destGUID ~= UnitGUID("player") and (eventType == "SPELL_DAMAGE" or eventType == "SWING_DAMAGE" or eventType == "RANGE_DAMAGE" or eventType == "SPELL_HEAL" or eventType == "SPELL_PERIODIC_HEAL") and amount > 0 then
        ...
        if spellName then
            ...
            if critical then
                print("Critical: " .. tostring(critical))
